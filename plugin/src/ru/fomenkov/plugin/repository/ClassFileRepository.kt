...
import ru.fomenkov.plugin.repository.data.ClassResource
...
class ClassFileRepository : ResourceRepository<ClassResource>() {
    ...
    override fun scan() {
        val time = timeMillis {
            ...
            val output = ConcurrentHashMap<String, ClassResource>()
    ...
    private fun scanBuildDirectory(moduleBuildPath: String, output: MutableMap<String, ClassResource>) {
        ...
        classFilePaths.forEach { path ->
            ...
            val resource = ClassResource(packageName = packageName, classFilePath = path)
